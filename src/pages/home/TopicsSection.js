                ...
                <div className="react__title__section react__title__section2">
                    <div className="row align-v">
                        <div className="col-md-8">
                            <h2 className="react__tittle wow animate__fadeInUp" data-wow-duration="0.3s"> Popular Gospel Piano Topics <b/> Students Love </h2>
                        </div>
                        <div className="col-md-4 text-right wow animate__fadeInUp" data-wow-duration="0.5s">
                            <Link to="/course">
                                View All Lessons <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
                            </Link>
                        </div>
                    </div>
                </div>                       
                <div className="row pt---30">
                    <div className="col-md-3 wow animate__fadeInUp" data-wow-duration="0.3s">
                        <div className="item__inner">
                            ...
                            <div className="react-content">
                                <h3 className="react-title"><Link to="/course">Gospel Chords</Link></h3>
                                <p>15 Lessons</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-3 wow animate__fadeInUp" data-wow-duration="0.5s">
                        <div className="item__inner">
                            ...
                            <div className="react-content">
                                <h3 className="react-title"><Link to="/course">Progressions</Link></h3>
                                <p>38 Lessons</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-3 wow animate__fadeInUp" data-wow-duration="0.7s">
                        <div className="item__inner">
                            ...
                            <div className="react-content">
                                <h3 className="react-title"><Link to="/course">Improvisation</Link></h3>
                                <p>24 Lessons</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-3 wow animate__fadeInUp" data-wow-duration="0.9s">
                        <div className="item__inner">
                            ...
                            <div className="react-content">
                                <h3 className="react-title"><Link to="/course">Worship Techniques</Link></h3>
                                <p>17 Lessons</p>
                            </div>
                        </div>
                    </div>
