                ...
                <div className="row">
                    ...
                    <div className="col-lg-6">
                        <div className="about__content">
                            <h2 className="about__title wow animate__fadeInUp" data-wow-duration="0.3s">Unlock the Power of <br /> <em>Gospel Piano</em></h2>
                            <p className="about__paragraph wow animate__fadeInUp" data-wow-duration="0.5s">Gospel Keys Demystified provides comprehensive piano lessons<br/> designed to help you master gospel music. From basic chords<br/> to advanced techniques, we've got you covered.</p>
                            <ul>
                                <li><i className="icon_check wow animate__fadeInUp" data-wow-duration="0.7s"></i> Learn authentic gospel piano techniques</li>
                                <li><i className="icon_check wow animate__fadeInUp" data-wow-duration="0.9s"></i> Master chords, progressions, and improvisations</li>
                            </ul>
