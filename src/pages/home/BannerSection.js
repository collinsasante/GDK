    ...
    const counters = [
        {
            ...
            countText: 'Students mastering gospel piano techniques.',
            countSubText: 'k+',
        },
        {
            countNum: 70,
            countIcon: countIcon2,
            countText: 'Gospel piano lessons available.',
            countSubText: '+',
        }
            ...
            <div className="hero3__area p-relative">
                ...
                <div className="container p-relative">                        
                    <div className="hero3__content">
                        <h1 className="hero3__title wow animate__fadeInUp" data-wow-duration="0.3s">Master Gospel Piano <br/> <em>Today</em></h1>
                        <img src={lineImg} alt="line" />
                        <form className="search-form wow animate__fadeInUp" data-wow-duration="0.5s">
                            <input type="text" className="form-input" placeholder="Search Gospel Piano Lessons" />
