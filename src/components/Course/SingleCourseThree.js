...
const SingleCourseThree = (props) => {
    const { itemClass, courseID, courseImg, courseName, courseTitle, courseAuthor, courseType, courseLesson, coursePrice, courseDuration, courseReview } = props;
	return(
        <div className={itemClass ? itemClass : 'single-studies grid-item'}>
            <div className="inner-course">
                <div className="case-img">
                    ...
                    <img src={courseImg ? require(`../../assets/images/course/${courseImg}`) : courseImg1} alt={courseTitle} />
                </div>
                <div className="case-content">
                    <h4 className="case-title"> <Link to={`/course/${courseID}`}>{courseTitle ? courseTitle : 'The Most Complete Design Thinking Course On The Market.'}</Link></h4>
                    ...
                    <ul className="react-ratings">
                        <li className="react-book"> <em>4.5</em>
                            ...
                            <span className="icon_star"></span>
                            <span className="icon_star"></span> ({courseReview})
                        </li>
